...
<head>
	...
	<title>Infiltrated - Přihlášení</title>
</head>
...
<body>
	...
	<main id="prihlaseni">
		<div class="prihlaseni-blok" id="border">
			<h2>Přihlášení</h2>
			<form method="post">
		...
		<div class="prihlaseni-blok">
			<H2>Registrace</H2>
			STAŇ SE ČLENEM KLUBU. ZÍSKEJ ODMĚNY.

			<p>Využij bonusovou uvítací nabídku pro nové členy.</p>
			<p>Získej okamžitý přístup ke všem členským výhodám.</p>
			<p>Získej možnost nakupovat modely v limitovaných edicích.</p>
			<p>Měj přehled o nejvýhodnějších speciálních nabídkách a slevových akcích.</p>
			<a class="input" id=registr href="Uzivatel-registrace.php">Zaregistruj se zde</a>
		</div>
	</main>
	<footer id="footer">
