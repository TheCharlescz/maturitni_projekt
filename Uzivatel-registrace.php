...
<head>
    ...
    <title>Registrace - Infiltrated</title>
</head>
...
<header id="Myheader">
    ...
    if (isset($_POST['ulozit'])) {
        ...
        if ($_POST['heslo'] !== $_POST['heslo-opakovani']) {
            ...
            if ($uzivatel->nastavRegistraci($_POST['email'], $_POST['heslo'])) {
                $db = new UzivatelDB();
                $id = $db->registraceUzivatele($uzivatel);
                if ($id > 0) {
    ...
    <div class="blok">
        ...
        <form method="post">
            ...
            <input class="ulozit" type="submit" name="ulozit" value="Zaregistrovat se">
        </form>
    </div>
    </main>
    <footer>
