        ...
        <div class="blok">
            <form method="post">
                <div id="flex">
                    <label> Osobní údaje
                        <div class="reg">
                            <input type="text" name="jmeno" placeholder="Jméno" value="<?php echo "$uzivatel->jmeno" ?>"
                                required> <br>
                            <input type="text" name="prijmeni" placeholder="Příjmení" echo"
                                value="<?php echo "$uzivatel->prijmeni" ?>" required><br>
                            <input type="email" name="email" placeholder="E-mail" echo"
                                value="<?php echo "$uzivatel->email" ?>" required><br>
                            <input type="tel" name="telkontakt" placeholder="Telefonní číslo"
                                value="<?php echo "$uzivatel->telkontakt" ?>" required><br>
                            <input type="text" name="ulice" placeholder="Ulice" value="<?php echo "$uzivatel->ulice" ?>"
                                required>
                            <input type="number" name="cislo_popisne" placeholder="Císlo popisné"
                                value="<?php echo "$uzivatel->cislo_popisne" ?>" required>
                            <input type="text" name="mesto" placeholder="Město" value="<?php echo "$uzivatel->mesto" ?>"
                                required><br>
                            <input type="number" name="PSC" placeholder="PSC" value="<?php echo "$uzivatel->PSC" ?>"
                                required><br>
                        </div>
                    </label>
                    <label> Přihlašovací údaje
                        <div class="reg">
                            <input type="text" name="login" placeholder="Přihlašovací login"
                                value="<?php echo "$uzivatel->login" ?>" required> <br>
